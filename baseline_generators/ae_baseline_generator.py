# ae_baseline_generator.py
# Generates statistical baseline for autoencoder score
...
def generate_ae_baseline(ae_column="ae_score"):

    train_df = load_full_training_data()
    series = train_df[ae_column]

    baseline = {
        "feature_name": "ae_score",
    ...
    with open("baseline/ae_baseline.json", "w") as f:
        json.dump(baseline, f, indent=4)

    print("AE baseline generated successfully.")
